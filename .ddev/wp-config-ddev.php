<?php
/**
 * WordCamp.org configuration file for DDEV.
 *
 * This is copied to public_html/wp-config.php by the setup script.
 * Adapted from .docker/wp-config.php with DDEV-specific database credentials.
 */
